...
class SelectGrid extends StatefulWidget {
  const SelectGrid({Key? key, required this.cotegory, required this.items, required this.isMulti, required this.minCheckCount}) : super(key: key);
  final bool isMulti;
  final int minCheckCount;
  final String cotegory;
  final List<String> items;
  @override
  _SelectGridState createState() => _SelectGridState();
}
